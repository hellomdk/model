								...
								<ul id="current_chat_list" class="list list_white" style="transition-property: -webkit-transform; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) translateZ(0px);">
									...
									<li id="recent-item-friend-78636695" class="list_item" _uin="78636695" _type="friend" cmd="clickMemberItem">
										<a class="avatar" cmd="clickMemberAvatar" _uin="78636695" _type="friend">
											<img src="${pageContext.request.contextPath }/img/girl.jpg">
										</a>
...
<script type="text/javascript">
	...
	if ('WebSocket' in window) {  
	  //  websocket = new WebSocket("ws://" + document.location.host + "/WebSocketTest/websocket/" + $("#userName").val());
	    websocket = new WebSocket("ws://" + document.location.host + "/websocket/" + $("#userName").val());
	} else {
	...
	websocket.onmessage = function(event) {
		...
		if(!$("div").is("."+info[1])){
			...
			"<img class='chat_content_avatar' src='${pageContext.request.contextPath }/img/girl.jpg' height='40px' width='40px'>"+
...
<script type="text/javascript">
	...
	function send1(){
		...
		$("."+$("#toName").html()).append("<div class='myself' _sender_uin='1564776288'><img class='myimg' src='${pageContext.request.contextPath }/img/girl.jpg' height='40px' width='40px'>"+
